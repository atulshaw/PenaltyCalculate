...
namespace PenaltyCalculate.API.DependencyResolution
{
    ...
    public class DefaultRegistry : Registry
    {
        ...
        public DefaultRegistry()
        {
            ...
            For<DbContext>().Use(() => new PenaltyCalculateEntities());
            For<IUnitOfWork>().Use<UnitOfWork>();
            For<IPenaltyCalculateRepository>().Use<PenaltyCalculateRepository>();
            For<IPenaltyCalculateService>().Use<PenaltyCalculateService>();

            For<ICountryMasterRepository>().Use<CountryMasterRepository>();
            For<ICountryMasterService>().Use<CountryMasterService>();
            #endregion
        }
